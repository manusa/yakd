...
export const PersistentVolumeIcon = ({...props}) => (
  <svg viewBox='0 0 18.035 17.5' {...props}>
    ...
    <g>
      <path
        d='M4.389 7.229c0 .621 2.072 1.125 4.629 1.125 2.556 0 4.629-.504 4.629-1.125v3.042c0 .622-2.073 1.125-4.63 1.125-2.556 0-4.628-.503-4.628-1.125z'
        fill='#fff'
        fillRule='evenodd'
      />
      <path
        d='M4.389 7.229c0-.621 2.072-1.125 4.629-1.125 2.556 0 4.629.504 4.629 1.125s-2.073 1.125-4.63 1.125c-2.556 0-4.628-.504-4.628-1.125z'
        fill='#fff'
        fillRule='evenodd'
      />
      <path
